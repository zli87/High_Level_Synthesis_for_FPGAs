; ModuleID = 'C:/Xilinx/streamMul/streamMul/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_smul_ir(%"class.hls::stream"* %INPUT, %"class.hls::stream"* %OUTPUT, i32 %length) local_unnamed_addr #0 {
entry:
  %INPUT_copy = alloca %"class.hls::stream", align 512
  %OUTPUT_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %INPUT, %"class.hls::stream"* nonnull align 512 %INPUT_copy, %"class.hls::stream"* %OUTPUT, %"class.hls::stream"* nonnull align 512 %OUTPUT_copy)
  call void @apatb_smul_hw(%"class.hls::stream"* %INPUT_copy, %"class.hls::stream"* %OUTPUT_copy, i32 %length)
  call fastcc void @copy_out(%"class.hls::stream"* %INPUT, %"class.hls::stream"* nonnull align 512 %INPUT_copy, %"class.hls::stream"* %OUTPUT, %"class.hls::stream"* nonnull align 512 %OUTPUT_copy)
  ret void
}
...
declare void @apatb_smul_hw(%"class.hls::stream"*, %"class.hls::stream"*, i32)

define void @smul_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, i32) #6 {
entry:
  call void @copy_out(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  call void @smul_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, i32 %2)
  call void @copy_in(%"class.hls::stream"* null, %"class.hls::stream"* %0, %"class.hls::stream"* null, %"class.hls::stream"* %1)
  ret void
}

declare void @smul_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, i32)
