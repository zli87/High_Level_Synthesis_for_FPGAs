...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("OUTPUT_r_TDATA", 32, hls_out, 4, "axis", "out_data", 1),
	Port_Property("OUTPUT_r_TVALID", 1, hls_out, 7, "axis", "out_vld", 1),
	Port_Property("OUTPUT_r_TREADY", 1, hls_in, 7, "axis", "out_acc", 1),
	Port_Property("OUTPUT_r_TKEEP", 4, hls_out, 5, "axis", "out_data", 1),
	Port_Property("OUTPUT_r_TSTRB", 4, hls_out, 6, "axis", "out_data", 1),
...
const char* HLS_Design_Meta::dut_name = "smul";
