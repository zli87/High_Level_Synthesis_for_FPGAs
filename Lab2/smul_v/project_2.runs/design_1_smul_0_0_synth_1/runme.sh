...
HD_PWD='C:/Xilinx/project_2/project_2.runs/design_1_smul_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_smul_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_smul_0_0.tcl
