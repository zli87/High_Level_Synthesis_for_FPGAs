...
execute()
{
  xrun $xrun_opts \
       ...
       -f run.f \
       -top glbl \
       +incdir+"$ref_dir/../../../../DFT_v.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../DFT_v.gen/sources_1/bd/design_1/ipshared/f42d/hdl" \
       +incdir+"../../../../DFT_v.gen/sources_1/bd/design_1/ipshared/ec67/hdl" \
       +incdir+"../../../../DFT_v.gen/sources_1/bd/design_1/ipshared/f42d/hdl" \
