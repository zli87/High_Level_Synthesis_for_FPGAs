...
HD_PWD='/mnt/c/Xilinx/Projects/DFT_v/DFT_v.runs/design_1_dft_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dft_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dft_0_4.tcl
