...
output   im_sample_we0;
output  [31:0] im_sample_d0;
...
reg   [10:0] loop_index13_load_reg_129;
reg   [10:0] loop_index13_load_reg_129_pp0_iter1_reg;
reg   [31:0] input_im_r_addr_read_reg_138;
reg    ap_condition_exit_pp0_iter1_stage0;
wire   [63:0] loop_index13_cast_fu_109_p1;
reg   [10:0] loop_index13_fu_46;
wire    ap_loop_init;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        if (((ap_enable_reg_pp0_iter0 == 1'b1) & (exitcond2510_fu_86_p2 == 1'd0))) begin
            loop_index13_fu_46 <= empty_25_fu_92_p2;
        end else if ((ap_loop_init == 1'b1)) begin
            loop_index13_fu_46 <= 11'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        exitcond2510_reg_134 <= exitcond2510_fu_86_p2;
        loop_index13_load_reg_129 <= ap_sig_allocacmp_loop_index13_load;
        loop_index13_load_reg_129_pp0_iter1_reg <= loop_index13_load_reg_129;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond2510_reg_134 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        input_im_r_addr_read_reg_138 <= m_axi_input_im_r_RDATA;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone) & (exitcond2510_reg_134 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (exitcond2510_reg_134 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (exitcond2510_reg_134 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond2510_reg_134 == 1'd0) & (m_axi_input_im_r_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond2510_reg_134 == 1'd0) & (m_axi_input_im_r_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

assign ap_block_state1_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state2_pp0_stage0_iter1 = ((exitcond2510_reg_134 == 1'd0) & (m_axi_input_im_r_RVALID == 1'b0));
end
...
assign empty_25_fu_92_p2 = (ap_sig_allocacmp_loop_index13_load + 11'd1);

assign exitcond2510_fu_86_p2 = ((ap_sig_allocacmp_loop_index13_load == 11'd1024) ? 1'b1 : 1'b0);

assign im_sample_address0 = loop_index13_cast_fu_109_p1;

assign im_sample_d0 = input_im_r_addr_read_reg_138;

assign loop_index13_cast_fu_109_p1 = loop_index13_load_reg_129_pp0_iter1_reg;
