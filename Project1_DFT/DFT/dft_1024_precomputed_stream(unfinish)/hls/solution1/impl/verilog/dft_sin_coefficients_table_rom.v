...
// ==============================================================
`timescale 1 ns / 1 ps
module dft_sin_coefficients_table_rom (
...
initial begin
    $readmemh("./dft_sin_coefficients_table_rom.dat", ram0);
    $readmemh("./dft_sin_coefficients_table_rom.dat", ram1);
    $readmemh("./dft_sin_coefficients_table_rom.dat", ram2);
    $readmemh("./dft_sin_coefficients_table_rom.dat", ram3);
end
