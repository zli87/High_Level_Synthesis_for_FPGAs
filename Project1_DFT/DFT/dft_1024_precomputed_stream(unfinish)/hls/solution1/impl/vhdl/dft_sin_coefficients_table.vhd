...
entity dft_sin_coefficients_table is
    generic (
...
architecture arch of dft_sin_coefficients_table is
    component dft_sin_coefficients_table_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    dft_sin_coefficients_table_rom_U :  component dft_sin_coefficients_table_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
