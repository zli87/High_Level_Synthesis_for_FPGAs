...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler dft_CTRL_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 302
set RegSliceName dft_regslice_both
set RegSliceInstName dft_regslice_both_U
set CoreName ap_simcore_dft_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
