...
set xo_kernel_name "dft"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/mnt/c/Xilinx/Projects/DFT/dft_1024_precomputed/hls/solution1"
set debug_dir "/mnt/c/Xilinx/Projects/DFT/dft_1024_precomputed/hls/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {dft_flow_control_loop_pipe_sequential_init
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL RW 0x0 {Control signals} {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 1 RESERVED_2 R 0 "Reserved.  0s on read." } { 9 1 RESERVED_3 R 0 "Reserved.  0s on read." } { 10 22 RESERVED_4 R 0 "Reserved.  0s on read." }}} {0x04 GIER RW 0x0 {Global Interrupt Enable Register} {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }}} {0x08 IP_IER RW 0x0 {IP Interrupt Enable Register} {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR RW 0x0 {IP Interrupt Status Register} {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 real_sample_1 W 0x0 "Data signal of real_sample" {{0 32 real_sample W 0 "Bit 31 to 0 of real_sample"}}} {0x14 real_sample_2 W 0x0 "Data signal of real_sample" {{0 32 real_sample W 0 "Bit 63 to 32 of real_sample"}}} {0x1c imag_sample_1 W 0x0 "Data signal of imag_sample" {{0 32 imag_sample W 0 "Bit 31 to 0 of imag_sample"}}} {0x20 imag_sample_2 W 0x0 "Data signal of imag_sample" {{0 32 imag_sample W 0 "Bit 63 to 32 of imag_sample"}}} {0x28 real_op_1 W 0x0 "Data signal of real_op" {{0 32 real_op W 0 "Bit 31 to 0 of real_op"}}} {0x2c real_op_2 W 0x0 "Data signal of real_op" {{0 32 real_op W 0 "Bit 63 to 32 of real_op"}}} {0x34 imag_op_1 W 0x0 "Data signal of imag_op" {{0 32 imag_op W 0 "Bit 31 to 0 of imag_op"}}} {0x38 imag_op_2 W 0x0 "Data signal of imag_op" {{0 32 imag_op W 0 "Bit 63 to 32 of imag_op"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_input_re_r m_axi_input_im_r m_axi_output_re_r m_axi_output_im_r"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_input_re_r {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_input_re_r"
        data_width "32"
        param_prefix "C_M_AXI_INPUT_RE_R"
    ...
    m_axi_input_im_r {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_input_im_r"
        data_width "32"
        param_prefix "C_M_AXI_INPUT_IM_R"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_output_re_r {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_output_re_r"
        data_width "32"
        param_prefix "C_M_AXI_OUTPUT_RE_R"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
    ...
    m_axi_output_im_r {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_output_im_r"
        data_width "32"
        param_prefix "C_M_AXI_OUTPUT_IM_R"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 6293544 II x}
