...
__attribute__((sdx_kernel("dft", 0))) void dft( DTYPE *, DTYPE *, DTYPE *, DTYPE *);
# 3 "dft.cpp" 2
...
# 4 "dft.cpp" 2
# 1 "/opt/Xilinx/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cstring" 1 3
# 40 "/opt/Xilinx/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cstring" 3
...
# 43 "/opt/Xilinx/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cstring" 2 3
# 71 "/opt/Xilinx/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cstring" 3
namespace std __attribute__ ((__visibility__ ("default")))
{
  ...
  using ::strrchr;
  using ::strstr;
# 121 "/opt/Xilinx/Vitis_HLS/2021.1/tps/lnx64/gcc-6.2.0/lib/gcc/x86_64-pc-linux-gnu/6.2.0/../../../../include/c++/6.2.0/cstring" 3
}
# 5 "dft.cpp" 2
__attribute__((sdx_kernel("dft", 0))) void dft( DTYPE *real_sample, DTYPE *imag_sample, DTYPE *real_op, DTYPE *imag_op)

{
#pragma HLS TOP name=dft
# 7 "dft.cpp"
...
#pragma HLS INTERFACE m_axi depth=50 max_widen_bitwidth=32 port=imag_op bundle=output_im_r
 ...
 DTYPE re_sample[1024];
 DTYPE im_sample[1024];
...
#pragma HLS array_partition variable=im_buff cyclic factor=128
 ...
 memcpy(re_sample,(const float*)real_sample,sizeof(DTYPE)*1024);
 memcpy(im_sample,(const float*)imag_sample,sizeof(DTYPE)*1024);


 loop_k: for (k=0 ; k<1024 ; ++k){
  float Xre;
  float Xim;
  loop_n: for (n=0 ; n<1024 ; ++n) {
#pragma HLS pipeline II=6
 ...
 if(0==n){
   ...
   float c = cos_coefficients_table[n*k %1024];
   float s = sin_coefficients_table[n*k %1024];
   float re_sample_n = re_sample[n];
   float im_sample_n = im_sample[n];
   float im_sample_n_neg = -1*im_sample[n];

   float Xre_part1 = re_sample_n * c;
   float Xre_part2 = im_sample_n * s;
   float Xim_part1 = re_sample_n * s;
   float Xim_part2 = im_sample_n_neg * c;
   Xre += Xre_part1 + Xre_part2;
   Xim += Xim_part1 + Xim_part2;
   if(1024 -1 == n){
    re_buff[k]=Xre;
    im_buff[k]=Xim;
   }
 ...
 memcpy(real_op,(const float*)re_buff,sizeof(DTYPE)*1024);
 memcpy(imag_op,(const float*)im_buff,sizeof(DTYPE)*1024);
}
