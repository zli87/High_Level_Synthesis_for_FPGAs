...
entity mul is
generic (
    C_S_AXI_MUL_IO_ADDR_WIDTH : INTEGER := 6;
...
architecture behav of mul is 
    ...
    "mul_mul,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=2.000000,HLS_SYN_LAT=0,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=112,HLS_SYN_LUT=168,HLS_VERSION=2020_2}";
...
begin
    mul_io_s_axi_U : component mul_mul_io_s_axi
    generic map (
