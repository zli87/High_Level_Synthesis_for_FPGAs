...
set C_modelArgMapList {[ 
	{ "Name" : "out_r", "interface" : "axi_slave", "bundle":"mul_io","type":"ap_vld","bitwidth" : 32, "direction" : "WRITEONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "out","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"out":16}, "offset_end" : {"out":23}} , 
 	{ "Name" : "in_r", "interface" : "axi_slave", "bundle":"mul_io","type":"ap_none","bitwidth" : 32, "direction" : "READONLY", "bitSlice":[{"low":0,"up":0,"cElement": [{"cName": "in","cData": "int","bit_use": { "low": 0,"up": 0},"cArray": [{"low" : 0,"up" : 0,"step" : 0}]}]}], "offset" : {"in":32}, "offset_end" : {"in":39}} ]}
# RTL Port declarations: 
set portNum 20
set portList { 
	{ s_axi_mul_io_AWVALID sc_in sc_logic 1 signal -1 } 
	{ s_axi_mul_io_AWREADY sc_out sc_logic 1 signal -1 } 
	{ s_axi_mul_io_AWADDR sc_in sc_lv 6 signal -1 } 
	...
	{ s_axi_mul_io_ARADDR sc_in sc_lv 6 signal -1 } 
...
set NewPortList {[ 
	{ "name": "s_axi_mul_io_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "mul_io", "role": "AWADDR" },"address":[{"name":"mul","role":"start","value":"0","valid_bit":"0"},{"name":"mul","role":"continue","value":"0","valid_bit":"4"},{"name":"mul","role":"auto_start","value":"0","valid_bit":"7"},{"name":"in_r","role":"data","value":"32"}] },
	...
	{ "name": "s_axi_mul_io_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "mul_io", "role": "ARADDR" },"address":[{"name":"mul","role":"start","value":"0","valid_bit":"0"},{"name":"mul","role":"done","value":"0","valid_bit":"1"},{"name":"mul","role":"idle","value":"0","valid_bit":"2"},{"name":"mul","role":"ready","value":"0","valid_bit":"3"},{"name":"mul","role":"auto_start","value":"0","valid_bit":"7"},{"name":"out_r","role":"data","value":"16"}, {"name":"out_r","role":"valid","value":"20","valid_bit":"0"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_io_s_axi_U", "Parent" : "0"}]}
