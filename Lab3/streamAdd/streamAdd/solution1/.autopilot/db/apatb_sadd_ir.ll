; ModuleID = 'C:/Xilinx/streamAdd/streamAdd/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sadd_ir(%"class.hls::stream"* %INPUT1, %"class.hls::stream"* %INPUT2, %"class.hls::stream"* %OUTPUT, i32 %length) local_unnamed_addr #0 {
entry:
  %INPUT1_copy = alloca %"class.hls::stream", align 512
  %INPUT2_copy = alloca %"class.hls::stream", align 512
  %OUTPUT_copy = alloca %"class.hls::stream", align 512
  call fastcc void @copy_in(%"class.hls::stream"* %INPUT1, %"class.hls::stream"* nonnull align 512 %INPUT1_copy, %"class.hls::stream"* %INPUT2, %"class.hls::stream"* nonnull align 512 %INPUT2_copy, %"class.hls::stream"* %OUTPUT, %"class.hls::stream"* nonnull align 512 %OUTPUT_copy)
  call void @apatb_sadd_hw(%"class.hls::stream"* %INPUT1_copy, %"class.hls::stream"* %INPUT2_copy, %"class.hls::stream"* %OUTPUT_copy, i32 %length)
  call fastcc void @copy_out(%"class.hls::stream"* %INPUT1, %"class.hls::stream"* nonnull align 512 %INPUT1_copy, %"class.hls::stream"* %INPUT2, %"class.hls::stream"* nonnull align 512 %INPUT2_copy, %"class.hls::stream"* %OUTPUT, %"class.hls::stream"* nonnull align 512 %OUTPUT_copy)
  ret void
}
...
declare void @apatb_sadd_hw(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, i32)

define void @sadd_hw_stub_wrapper(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, i32) #6 {
entry:
  ...
  call void @sadd_hw_stub(%"class.hls::stream"* %0, %"class.hls::stream"* %1, %"class.hls::stream"* %2, i32 %3)
...
declare void @sadd_hw_stub(%"class.hls::stream"*, %"class.hls::stream"*, %"class.hls::stream"*, i32)
